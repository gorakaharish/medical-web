...
const Services = () => {
  ...
  return (
    <div className='min-h-screen felx flex-col justify-center lg:px-32 px-5 pt-24 lg:pt-16'>
        <div className='flex flex-col items-center lg:flex-row justify-between'>
          <div>
            <h1 className='text-4xl font-semibold text*center lg:text-start'>Our Services</h1>
            <p className='mt-2 text-center lg:text-start'>Lorem, ipsum dolor sit amet consectetur adipiscing elit, Enim, molesitias</p>
          </div>
